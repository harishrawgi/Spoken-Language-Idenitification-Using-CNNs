...
parser.add_argument('--network', type=str, default="tc_net_mod_reduced", help='embeding size (50, 100, 200, 300 only)')
parser.add_argument('--epochs', type=int, default=500, help='number of epochs to train')
#parser.add_argument('--load_state', type=str, default="C:/Users/shraw/Python Workspace/lid/Spoken-language-identification-master/theano/states/tc_net_mod_reduced.bs32.bn.epoch1.test1.18877.state", help='state file path')
...
if (args.equal_split):
    train_listfile = open("C:/Users/shraw/Python Workspace/lid/Spoken-language-identification-master/data/spectograms/train.csv", "r")
    test_listfile = open("C:/Users/shraw/Python Workspace/lid/Spoken-language-identification-master/data/spectograms/validate.csv", "r")
else:
    train_listfile = open("C:/Users/shraw/Python Workspace/lid/Spoken-language-identification-master/data/spectograms/train.csv", "r")
    test_listfile = open("C:/Users/shraw/Python Workspace/lid/Spoken-language-identification-master/data/spectograms/validate.csv", "r")
...
args_dict['png_folder'] = "C:/Users/shraw/Python Workspace/lid/Spoken-language-identification-master/data/spectograms/png/"
...
def do_epoch(mode, epoch):
    ...
    #print (metrics.confusion_matrix(y_true, y_pred), file=open("confusion.txt", "w"))
    cm = metrics.confusion_matrix(y_true, y_pred)
    np.savetxt("confussion.csv", cm, delimiter=",")
    prfs = metrics.precision_recall_fscore_support(y_true, y_pred)
    np.savetxt("prfs.csv", prfs, delimiter=",")
