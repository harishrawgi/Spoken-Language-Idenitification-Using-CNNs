...
""" plot spectrogram"""
def plotstft(audiopath, filename, binsize=2**10, plotpath=None, colormap="jet"):
    ...
    print(audiopath[:-3] + "png")
    image.save(audiopath[:-3] + "png")
...
directory = "C:/Users/shraw/Python Workspace/lid/Spoken-language-identification-master/data/raw/Dutch" 
for filename in os.listdir(directory):
    if filename.endswith(".wav"):
        #print(filename)
        plotstft(directory + "/" + filename, filename)
